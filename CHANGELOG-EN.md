...
Fixed native/frontend auth restore convergence, QQ artwork filtering, guest catalog isolation, shuffle/automatic
advance, lyric timeline changes, overlay lifecycle and lock recovery, control alignment, account response parsing,
recent-history compatibility, and PlayerBar quality-menu overlap.
