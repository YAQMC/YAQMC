...
export function renderBaseline(
  ...
  const lines = [
    ...
    '',
    '## Current release artifact name patterns',
    '',
    ...
    '',
    'Patterns are controlled by the desktop and Android staging scripts plus the unified release assembler. Desktop `{arch}` is `x64` or `arm64`; updater metadata is published only from the x64 desktop packages, while the Android release is `arm64-v8a`.',
    '',
