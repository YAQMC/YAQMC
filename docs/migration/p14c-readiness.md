...
| Production QMC library path                          | NOT STARTED | Real-file golden, then route `EncryptedMedia` to the adapter     |
...
2. Rerun P14-B on the exact pin, including the real QMC file golden. Then route
