...
class DeepLinkManagerTest {
    ...
    fun acceptsOnlyStrictCatalogLink() {
        assertEquals(
            CatalogSongDeepLink("qqmusic", "alternate", "qqmusic:track:000qgbM90wbOxx"),
        ...
        assertNull(DeepLinkManager.parse("yaqmc://catalog/qqmusic/song?id=a&profileId="))
        assertNull(DeepLinkManager.parse("yaqmc://catalog/qqmusic/song?id=a&profileId=bad%20profile"))
        assertNull(DeepLinkManager.parse("yaqmc://catalog/qqmusic/song?id=a&profile=alternate"))
    ...
    @Test
    fun acceptsLegacyAndBothQueryOrders() {
        assertEquals(
            CatalogSongDeepLink("qqmusic", "default", "a"),
            DeepLinkManager.parse("yaqmc://catalog/qqmusic/song?id=a"),
        )
        assertEquals(
            CatalogSongDeepLink("qqmusic", "alternate", "a"),
            DeepLinkManager.parse("yaqmc://catalog/qqmusic/song?profileId=alternate&id=a"),
        )
    }
    ...
    fun eachIntentIdentityIsConsumedOnce() {
        ...
        assertEquals(CatalogSongDeepLink("qqmusic", "default", "a"), manager.accept(first, link))
        assertNull(manager.accept(first, link))
        assertEquals(CatalogSongDeepLink("qqmusic", "default", "a"), manager.accept(Any(), link))
    }
}
