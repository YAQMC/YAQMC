...
- **[amll-dev/applemusic-like-lyrics](https://github.com/amll-dev/applemusic-like-lyrics)** — the implementation
  source for lyric timing, interludes, and motion hierarchy. YAQMC uses the official
