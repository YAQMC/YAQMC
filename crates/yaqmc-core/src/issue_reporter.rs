...
//! issue-form URL that the frontend can either open through its scoped host opener
//! boundary or copy-to-clipboard as a fallback.
//!
//! Design constraints:
...
pub fn prepare_preview(
    ...
    let body = compose_body(draft, snapshot, renderer_label);
