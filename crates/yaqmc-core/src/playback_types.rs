//! Provider-neutral playback values shared by the host shim and future Core services.
//!
//! `PlaybackEpoch` deliberately has no serde or `Debug` implementation: it fences in-process
//! work by generation and opaque provider scope, and is not a frontend or protocol DTO.
