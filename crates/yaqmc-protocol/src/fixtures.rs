...
fn events() -> Value {
    json!({
        ...
        CHANNEL_LYRICS_SURFACE_INTERACTION: to_value(&CoreMessage::Event {
            seq: 11,
            channel: CHANNEL_LYRICS_SURFACE_INTERACTION.to_owned(),
            payload: json!({ "kind": "desktop", "interaction": "passive-locked" }),
        }),
