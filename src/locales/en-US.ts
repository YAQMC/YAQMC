export const enUS = {
  ...
  pages: {
    ...
    statistics: {
      ...
      title: 'Statistics',
      subtitle: 'Private listening insights calculated locally from actual playback progress.',
      ranges: 'Statistics range',
      range: {
        '7-days': '7 days',
        '30-days': '30 days',
        '365-days': '1 year',
      ...
      loading: 'Loading listening statistics',
      loadFailed: 'Listening statistics could not be loaded.',
      actionFailed: 'The statistics action failed: {{error}}',
      listeningTime: 'Qualified listening',
      qualifiedPlays: 'Qualified plays',
      completed: 'Completed',
      skipRate: 'Skip rate',
      trend: 'Listening trend',
      trendDescription: 'Daily qualified listening time',
      topSongs: 'Top songs',
      topArtists: 'Top artists',
      topAlbums: 'Top albums',
      byQuality: 'Playback quality',
      byProvider: 'Music providers',
      noItems: 'No qualified plays in this range.',
      unknown: 'Unknown',
      emptyTitle: 'No listening statistics yet',
      emptyBody: 'Play music normally and qualified sessions will appear here.',
      exportJson: 'Export JSON',
      exportCsv: 'Export CSV',
      exporting: 'Exporting…',
      exported: 'Exported {{count}} listening sessions.',
      localData: 'Local statistics data',
      databaseSize: 'Database size, including active SQLite files: {{size}}',
      clear: 'Clear statistics',
      clearWarning: 'Only listening statistics will be removed. Library and settings stay intact.',
      confirmClear: 'Confirm clear',
      clearing: 'Clearing…',
      cleared: 'Cleared {{count}} listening sessions.',
    },
    home: {
    ...
    explore: {
      ...
      empty: 'No discover categories are available right now.',
      tabsLabel: 'Discover categories',
    ...
    library: {
      eyebrow: 'YOUR MUSIC',
      hubTitle: 'Library',
      hubDescription: 'Your saved music, listening history, and private local insights.',
      hubFavorites: 'Songs saved to your QQ Music account',
      hubPlaylists: 'Playlists you created or saved',
      hubRecent: 'Recent QQ Music and local playback',
      hubStatistics: 'Statistics',
      hubStatisticsDescription: 'Private listening insights stored on this device',
    ...
    search: {
      ...
      introQq: 'Search QQ Music for songs, albums, artists, and playlists.',
      ...
      tabsLabel: 'Search categories',
      loading: 'Loading…',
      loadingCategory: 'Loading {{category}}…',
      loadMore: 'Load more {{category}}',
      retry: 'Retry',
      paginationFailed: 'Couldn’t load more {{category}}.',
      emptyCategory: 'Try different {{category}} or a shorter phrase.',
      noPlaylists: 'No playlists to browse.',
    ...
    song: {
      ...
      more: 'More song actions',
      favorite: 'Add {{title}} to Favorites',
    ...
    artist: {
      ...
      topSongs: 'Top songs',
      albums: 'Albums',
      tabsLabel: 'Artist catalog',
      allSongs: 'All songs',
      allAlbums: 'All albums',
      loading: 'Loading {{category}}…',
      unavailable: '{{category}} unavailable',
      emptySongs: 'No songs available',
      emptyAlbums: 'No albums available',
      retry: 'Retry',
      paginationFailed: 'Could not load more {{category}}.',
      loadMore: 'Load more {{category}}',
      loadingMore: 'Loading more {{category}}…',
      openAlbum: 'Open {{title}}',
    },
    area: {
      eyebrow: 'MUSIC AREA',
  ...
  player: {
    ...
    addToQueue: 'Add to queue',
    copyPublicSongLink: 'Copy public song link',
    copyYaqmcSongLink: 'Copy YAQMC link',
    copySongText: 'Copy song and artist',
    shareCopied: 'Song share content copied.',
  ...
  accountDialog: {
    ...
    scanAlt: 'Scan to sign in to {{provider}}',
    guest: 'Choose an authorization method for {{provider}}',
    restoring: 'Restoring your account session',
    starting: 'Opening the official authorization window',
    waitingScan: 'Scan the QR code to authorize {{provider}}, then follow the device prompt',
    waitingMobileScan: 'Waiting for QQ Music to confirm this YAQMC authorization',
    waitingConfirmation: 'Complete sign-in in the provider authorization window',
    expired: 'This authorization attempt expired',
    rejected: '{{provider}} rejected this sign-in',
    cancelled: 'Sign-in was cancelled',
    networkError: '{{provider}} could not be reached',
    protocolError: '{{provider}} returned an unexpected response',
    authenticated: 'Signed in as {{nickname}}',
    sessionExpired: 'Your {{provider}} session expired',
    ...
    signInQqMusicApp: 'Open QQ Music to sign in',
    reopenQqMusicApp: 'Open QQ Music again',
    mobileCurrentQrNotice:
      'This QR belongs to the current attempt. Open QQ Music again, or scan this QR using QQ Music. Signing in to QQ Music itself does not complete YAQMC authorization.',
    retry: 'Start again',
    signInWechat: 'Continue with WeChat',
    signOut: 'Sign out on this device',
    signingOut: 'Signing out…',
    oauthNotice:
      'YAQMC opens a restricted {{provider}} authorization window. Enter credentials only there.',
    mobileQqNotice:
      'YAQMC opens the QQ Music app for authorization. If it is unavailable, a QR code remains available for another device.',
    cancel: 'Cancel sign-in',
    refresh: 'Refresh QR code',
    busy: 'Please wait…',
    errorNetwork: '{{provider}} could not be reached. Try again when the network is available.',
    ...
    errorProtocol: '{{provider}} returned an unexpected response.',
  ...
  settings: {
    ...
    appearance: {
      ...
      modeLight: 'Light',
      modeDark: 'Dark',
      interfaceFontScale: 'Interface font size',
      interfaceFontScaleDescription:
        'Scales application text without changing lyrics or desktop-lyrics surfaces.',
      interfaceFontScaleValue: '{{value}}%',
      interfaceFontFamily: 'Interface font',
      interfaceFontFamilyDescription:
        'Choose a curated font stack for application text and headings.',
      interfaceFontApplication: 'YAQMC default',
      interfaceFontSystem: 'System sans serif',
      interfaceFontSerif: 'Serif',
      interfaceFontMonospace: 'Monospace',
    ...
    lyrics: {
      ...
      wordJump: 'Word jump',
      wordJumpDescription: 'Bounce individual words in the active lyric line.',
      fontSize: 'Lyrics font size',
      fontSizeDescription: 'Adjusts the active lyrics preset without opening its custom editor.',
      fontSizeValue: '{{value}}%',
      lineSpacing: 'Lyrics line spacing',
      lineSpacingDescription: 'Adjusts the active lyrics preset without opening its custom editor.',
      lineSpacingValue: '{{value}}×',
      fontWeight: 'Lyrics font weight',
      fontWeightDescription: 'Applies to both synced AMLL lyrics and static lyrics.',
      fontWeightRegular: 'Regular (400)',
      fontWeightMedium: 'Medium (500)',
      fontWeightSemibold: 'Semibold (600)',
      fontWeightBold: 'Bold (700)',
      fontWeightExtrabold: 'ExtraBold (800)',
      fontWeightBlack: 'Black (900)',
      amllSpring: 'Spring scrolling',
      amllSpringDescription:
        'Use AMLL’s physics-based line-following animation. Reduced motion always disables it.',
      amllScale: 'Active-line scale',
      amllScaleDescription: 'Emphasize the active lyric line with AMLL scale animation.',
      amllBlur: 'Inactive-line blur',
      amllBlurDescription: 'Soften unfocused lyrics with AMLL blur.',
      amllHidePassedLines: 'Hide passed lines',
      amllHidePassedLinesDescription: 'Remove lines after they have been sung.',
    ...
    account: {
      title: 'Music provider account',
      description: 'Provider connectivity and authorization capability.',
      provider: 'Active music provider',
      providerDescription: 'Catalog, account, lyrics, and new playback requests use this provider.',
      providerLabel: 'Active music provider',
      profilesTitle: 'Accounts and profiles',
      profilesDescription: 'Manage separate profiles for each music platform.',
      profileEnabled: 'Enabled',
      profileDisabled: 'Disabled',
      profileCurrent: 'Current',
      profileSwitch: 'Switch',
      profileEnable: 'Enable',
      profileDisable: 'Disable',
      profileDelete: 'Delete',
      profileDeleteConfirm: 'Delete profile “{{label}}”? This cannot be undone.',
      profileNewLabel: 'New QQ Music profile',
      profileNewPlaceholder: 'Profile name',
      profileAdd: 'Add profile',
      profileMutationFailed: 'The profile change could not be applied.',
      online: 'Online',
      cached: 'Cached',
      offline: 'Offline',
      ...
      authorizingMessage: 'Complete sign-in in the restricted {{provider}} authorization window.',
      ...
      rejectedMessage: '{{provider}} rejected the authorization request.',
      networkMessage: '{{provider}} could not be reached. Your saved session was not discarded.',
      protocolMessage: '{{provider}} returned an unexpected response.',
      ...
      security:
        'YAQMC uses a restricted {{provider}} authorization window. It never reads passwords or imports browser session data.',
    },
    storage: {
      title: 'Storage',
